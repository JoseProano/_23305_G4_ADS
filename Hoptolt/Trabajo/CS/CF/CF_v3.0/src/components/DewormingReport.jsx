...
import '../styles/DewormingReport.css';
...
const DewormingReport = () => {
    ...
    const generateReportPreview = async (e) => {
        ...
        try {
            const response = await fetch('http://localhost:5000/api/reports/deworming-report', {
                method: 'POST',
                headers: {
    ...
    const downloadPDF = async () => {
        ...
        try {
            const response = await fetch('http://localhost:5000/api/reports/deworming-report/pdf', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                },
            ...
            if (response.ok) {
                ...
                link.href = url;
                link.download = `Reporte_Desparasitacion_${new Date().toLocaleDateString('es-ES').replace(/\//g, '-')}.pdf`;
    ...
    return (
        <div className="deworming-report-container">
            <div className="report-header">
                <h2>📊 Generar Reporte de Desparasitación</h2>
                <p>Genere reportes de desparasitación aplicadas por raza y período de tiempo</p>
            </div>
            ...
            {!showPreview ? (
                ...
                <div className="preview-section">
                    <div className="preview-header">
                        <h3>📋 Vista Previa del Reporte de Desparasitación</h3>
