...
## Overview
The Rabbit Management System is a full-stack application designed to manage data related to rabbits. It allows users (breeders) to register, edit, delete, and consult information about rabbits.

## Features
- **CRUD Operations**: Users can create, read, update, and delete information.
